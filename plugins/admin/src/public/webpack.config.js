module.exports = {
    ...
    module: {
        ...
        loaders: [{
                test: '/base64/',
                loader: 'exports?base64'
            }, {
                test: '/(alerts|dropdown|tabs|tooltip|abide)/',
                loader: 'imports?foundation'
            }, {
                test: '/foundation/',
                loader: 'exports?Foundation!imports?jquery'
            }, {
                test: '/jqueryui/',
                loader: 'exports?jqueryui!imports?jquery'
            }, {
                test: '/select2/',
                loader: 'exports?jquery!imports?jquery'
            }, {
                test: '/widgetFactory/',
                loader: 'exports?jquery!imports?jqueryui'
            }, {
                test: '/mouseInteraction/',
                loader: 'exports?jquery!imports?jqueryui,widgetfactory' //this seems like a circular dependency
            }, {
                test: '/sortable/',
                loader: 'exports?jquery!imports?jqueryui,widgetFactory,mouseInteraction'
            }, {
                test: '/accordion/',
                loader: 'exports?jquery!imports?jqueryui,widgetFactory'
            }, {
                test: '/ckeditorAdapter/',
                loader: 'exports?jquery!imports?jquery,ckeditor'
            }, {
                test: '/scrollToFixed/',
                loader: 'exports?jquery!imports?jquery'
            }, {
                test: '/(datetimepicker|velocity|multipleSelect)/',
                loader: 'imports?jquery'
            }, {
                test: '/momentTimezoneWithData/',
